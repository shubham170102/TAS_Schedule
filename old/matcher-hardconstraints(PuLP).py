...
# Open Excel Files
studentsDataFile_Location = 'data\REAL_Students_3.0.xlsx'
coursesDataFile_Location = 'data\REAL_Courses_4.0.xlsx'
...
studentFirstChoices = studentsDataFile['Preference_1'].tolist()
studentSecondChoices = studentsDataFile['Preference_2'].tolist()
studentThirdChoices = studentsDataFile['Preference_3'].tolist()
